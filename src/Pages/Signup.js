...
import './Signup.css';
import bot from '../assets/Img.png';
...
async function uploadImage(){
  ...
  data.append('upload_preset', 'v2rytji2'); //cloudinary upload preset unsigned token
  try {
    setUploadingImg(true);
    let res= await fetch('https://api.cloudinary.com/v1_1/ds5vvlc6e/image/upload',{  //cloudinary link using api name
      method: 'POST',
      body: data
    })
