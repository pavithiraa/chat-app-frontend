  ...
  return (
    ...
    {user && privateMemberMsg?._id && (
        ...
        <div className="alert alert-info conversation-info">
            <div>
                Your conversation with {privateMemberMsg.name} <img src={privateMemberMsg.picture} alt="picture" className="conversation-profile-picture" />
            </div>
        </div>
        </>
    )}
                 ...
                 <div className={sender?.email === user?.email ? "message" : "incoming-message"} key={msgIdx} >
                     <div className="message-inner">
                         <div className="d-flex align-items-center mb-3">
                             <img src={sender.picture} alt= "image" style={{width: 35, height:35, objectFit: 'cover', borderRadius: '50%', marginRight:10}} />
